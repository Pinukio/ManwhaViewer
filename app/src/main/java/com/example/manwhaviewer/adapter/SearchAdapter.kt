package com.example.manwhaviewer.adapter
...
import com.example.manwhaviewer.data.Searched
import com.example.manwhaviewer.fragment.SearchFragment

class SearchAdapter(val list : ArrayList<Searched>, val dialog : AlertDialog, val frag : SearchFragment) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
